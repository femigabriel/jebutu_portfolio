    ...
    <div className="p-5 pt-10 lg:px-20 flex items-center justify-center">
      <div>
        ...
        <p className="lg:text-[18px] sm:text-[14px] text-gray-100 lg:w-[45em] sm:w-[38em] leading-relaxed  mt-20 tracking-widest mb-10">
          ...
          and academic knowledge to excel and make a difference in an accounting
          position in any firm. Dedicated, competent, and detail oriented
          individual with the capacity to go beyond what is expected and achieve
          company goals. An intelligent economist with a significant amount of
          expertise in education, healthcare, and hospitality industry.
          Possessing in-depth knowledge of complex economic concepts,
          mathematics, analytical, marketing, and adept at applying theories and
